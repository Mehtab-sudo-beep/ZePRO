...
public class FacultyCoordinatorService {
        ...
        public FacultyCoordinatorService(StudentRepository studentRepository,
        ...
        public DashboardStatsResponse getDashboardStats() {
                ...
                Integer totalUsedSlotsInt = facultyRepository.sumAllocatedStudents();

                int totalMaxSlots = (totalMaxSlotsInt != null) ? totalMaxSlotsInt : 0;
                int totalUsedSlots = (totalUsedSlotsInt != null) ? totalUsedSlotsInt : 0;
                int availableSlots = totalMaxSlots - totalUsedSlots;
        ...
        public void allocateStudentToFaculty(AllocateStudentRequest request) {
                ...
                faculty.setAllocatedStudents(faculty.getAllocatedStudents() + 1);
        ...
        public void overrideStudentAllocation(OverrideAllocationRequest request) {
                ...
                oldFaculty.setAllocatedStudents(oldFaculty.getAllocatedStudents() - 1);
                facultyRepository.save(oldFaculty);

                newFaculty.setAllocatedStudents(newFaculty.getAllocatedStudents() + 1);
        ...
        private CoordinatorFacultyResponse mapToFacultyResponse(Faculty f) {
                ...
                return new CoordinatorFacultyResponse(f.getFacultyId(), f.getUser().getName(),
                                f.getUser().getEmail(), deptName, f.getMaxStudents(), f.getAllocatedStudents(),
                                f.getSpecialization());
        }
