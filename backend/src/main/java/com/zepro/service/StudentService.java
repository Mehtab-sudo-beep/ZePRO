...
public class StudentService {
        ...
        public String requestProject(ProjectRequestDTO request) {
            ...
            System.out.println("[StudentService] ✅ Project request sent to faculty: " + project.getFaculty().getUser().getName());
