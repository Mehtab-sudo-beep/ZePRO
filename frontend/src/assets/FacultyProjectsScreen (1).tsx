    ...
    <Modal visible={visible} transparent animationType="none" onRequestClose={onClose}>
      ...
      >
        ...
        >
          ...
          <View style={[styles.activeBanner, { backgroundColor: isActive ? '#3edba7ff' : '#EF4444' }]}>
                ...
                <View style={styles.cardInner}>
                  <View style={styles.titleRow}>
                    ...
                    <TouchableOpacity
                      ...
                      style={[styles.editBtn, { backgroundColor:  }]}
...
const styles = StyleSheet.create({
  ...
  editBtn: { paddingHorizontal: 12, paddingVertical: 5, borderRadius: 8 },
